...
<a href={`/aktivitet/${activity.id}`} class="relative flex flex-col bg-card border border-border rounded-md overflow-hidden cursor-pointer">
    ...
    <div class="flex flex-1 flex-col p-4">
        ...
        <p class="cursor-pointer text-muted-foreground text-sm">{truncate(activity.description)}</p>
    </div>
</a>
